      ...
      <nav className="container mx-auto p-4 flex justify-between items-center">
        <div className="flex items-center space-x-4">
          <Link href="/" className="flex items-center space-x-2">
            <span id="animated-name" className=" text-xl tracking-wide font-medium font-inter" >Algoinvest SaaS Offering</span>
          </Link>
        </div>
        <div className="flex space-x-4 items-center">
          <div className="hidden gap-5 mr-5 lg:flex space-x-4 font-semibold">
            <Link id="animated-btn" href="https://algoinvest.netlify.app" className="hover:text-purple-500 tracking-wide font-medium font-inter transition-colors duration-300">Contact</Link>
            <Link id="animated-btn" href="https://docs.google.com/document/d/1PB_t0Veemo2wk-spnX9Wf4hWPzMkAGGa-VJGRV1iXuA/edit?usp=sharing" className="hover:text-purple-500 tracking-wide font-medium font-inter transition-colors duration-300">About</Link>
          </div>
          {!session ? (
